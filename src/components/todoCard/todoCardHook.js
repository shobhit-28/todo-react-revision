...
export const TodoHook = (todo) => {
    const { markTodoAsDone, changeTodoDueDate } = useContext(TodoContext)
    ...
    return { isCalendarOpen, setIsCalendarOpen, priorityStyles, processDate, toggleTodo, closeCalendar }
}